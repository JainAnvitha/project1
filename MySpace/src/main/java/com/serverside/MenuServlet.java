...
import com.database.FileDetailsToDatabase;
...
public class MenuServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
      ...
      String username= request.getSession(true).getAttribute("username").toString();
        ...
        System.out.println("unmae in menuservelet"+username);
        ...
        AWSCredentials credentials = new BasicAWSCredentials(
            ...
            System.out.println("Menuservelet");
...
for(Part p:fileParts){
    System.out.println("p: "+p.getName());
       ...
       System.out.println("flag menuserv"+flagForNewFolder);
       if(flagForNewFolder)
        createFolder(bucketName, username, s3client);
         ...
         { 
          ...
          System.out.println("fileNameofallusers  "+fileName);
          ...
          System.out.println("fullpathoffile  "+completeFilePath);
